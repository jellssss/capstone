  ...
  <section class="main">
    ...
    <div class="main--content">
      <div class="recent--patients">
        <h2 class="section--title">Resigned Employee Records</h2>
        ...
        <a href="add_rec.php" class="btn btn-primary">Add Employee</a>
      </div>
        ...
        <div class="table-container">
          <table class="table table-striped table-bordered">
            ...
            if ($conn->connect_error) {
              ...
              $sql = "SELECT * FROM empreco WHERE status = 'Resigned'"; // Added WHERE clause to filter active employees
...
function archiveEmployee(employeeID) {
    if (confirm('Are you sure you want to archive this employee?')) {
        ...
        fetch(`archive_employee.php?id=${employeeID}`)
