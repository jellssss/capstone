...
if (isset($_POST['add_employee'])) {
    ...
    $salary = $_POST['salary'];
    $status = 'Resigned'; // Example status; you can modify as needed
    ...
    <div class="container mt-5">
        ...
        <form method="POST" action="">
           ...
           <div class="form-group">
			...
			<button type="button" onclick="window.location.href='resignedtwo.php'" class="delete-btn btn-block">Go back</button>
        </form>
    </div>
